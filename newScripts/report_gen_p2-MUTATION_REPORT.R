...
GENERATE_CHI_SQ_REPORT <- as.integer(GENERATE_CHI_SQ_REPORT)
...
if(WHAT_TO_RUN == 4) {
  ...
  report <- read.csv(paste(path.expand(path),"reports","MAF_cutoff_report.csv",sep="/"),header=TRUE, check.names=FALSE)
} 
