...
#path <- "/home/benrancourt/Desktop/junjun/pipelineForExom14706Ref"
path <- args[1]

#reportsSubDir <- "reports"
reportsSubDir <- args[2]

#inputMAFcutoffReportName <- "MAF_cutoff_report.csv"
inputMAFcutoffReportName <- args[3]

outputMAFcutoffReportNameDepth <- paste0(inputMAFcutoffReportName,"_depth.csv")
outputMAFcutoffReportNameDepthDetailed <- paste0(inputMAFcutoffReportName,"_depth_detailed.csv")
